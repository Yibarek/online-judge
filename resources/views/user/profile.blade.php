              ...
              <div class="tab-content pt-2">
                ...
                <div class="tab-pane fade show active profile-overview" id="profile-overview">
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8">{{Auth::user()->organization}}</div>
                  </div>

                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">College</div>
                    <div class="col-lg-9 col-md-8">{{Auth::user()->college}}</div>
                  </div>
                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Department</div>
                    <div class="col-lg-9 col-md-8">{{Auth::user()->department}}</div>
                  </div>
                  <div class="row">
                ...
                <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                  ...
                  <!-- Profile Edit Form -->
                  <form action="/profile/changeProfile" id="change-profile" method="POST">
                    @csrf
                    <div class="row mb-3">
                      <label for="profileImage" class="col-md-4 col-lg-3 col-form-label">Profile Image</label>
                      <div class="col-md-8 col-lg-9">
                        <div id="profile_photo" class="rounded-circle"><img src="../../image/profile/{{Auth::user()->profile_image}}" alt="Profile" style="width: 40%; height: 89%;"></div>
                        <div class="pt-2">
                          <a type="button" class="btn btn-primary btn-sm"id="img1" onclick="document.getElementById('img').click();" title="Upload new profile image"><i class="bi bi-upload"></i></a>
                          <a type="button" href="/deleteProfile" class="btn btn-danger btn-sm" title="Remove my profile image"><i class="bi bi-trash"></i></a>
                        </div>
                        {{-- //////////////////////////////// --}}
                        <div class="container">
                              ...
                              <div class="form-group" style="display: none;">
                                <label for="pwd"></label>
                                <input type="file" class="custom-file-input" style="margin-top: 10px;" name="img" id="img">
                              </div>
                          </div>
                              ...
                              filesArr.forEach(function (f) {
                                ...
                                reader.onload = function (e) {
                                  var html =
                                    ...
                                    "\" data-file='" +
                                    f.name +
                                    "alt='Category Image' height='89%' width='40%' class='rounded-circle'>";
                                  selDiv.html(html);
                                };
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="organization" type="text" class="form-control" id="organization" value="{{Auth::user()->organization}}">
                      </div>
                    </div>

                    <div class="row mb-3">
                      <label for="company" class="col-md-4 col-lg-3 col-form-label">College</label>
                      <div class="col-md-8 col-lg-9">
                        <input name="college" type="text" class="form-control" id="college" value="{{Auth::user()->college}}">
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="department" type="text" class="form-control" id="department" value="{{Auth::user()->department}}">
                      </div>
                    </div>
                    ...
                    <div class="text-center">
                        <input href="/profile/changeProfile" type="submit" class="btn btn-primary" value="save Profile">
                    </div>
                    </form>
                ...
                <div class="tab-pane fade pt-3" id="profile-change-password">
                  ...
                  <form action="/profile/changePassword" id="change_password-form" method="GET">
