...
<body style="position: relative;
    ...
    <div id="app" >
        ...
        <header id="header" class="fixed-top d-flex align-items-center " style="width: 100%;">
            <div class="d-flex justify-content-between align-items-center" style="width: 95%; margin: auto;">

              <div class="logo d-flex " style="width: 15%;">
        ...
        <div style="width: 100%;" class="d-flex justify-content-between">
            <div class="d-flex">
                ...
                <li><a class="nav-link scrollto " id="problem" href="/p/0">Problems</a></li>
