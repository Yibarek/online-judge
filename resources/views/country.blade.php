  ...
  <div class="container2 p-2" style="">
    ...
    <div class="d-flex justify-content-between" style="width: 100%; height: 30px; border-radius: 5px;">
        <div style="font-weight: bold;">
            ...
            <label class="page_title">Countries</label>
        </div>
        @auth
            <div class=" " style="width: 200px;">
                @if (Auth::user()->role == "superadmin")
                 <a href="#" data-bs-toggle="modal" data-bs-target="#popup"
                    ...
                    class="anchor p-2"> Add new Country</a>
                @endif
            </div>
        @else
            <div>.</div>
      ...
      <table class="table table-borderless datatable table-hover table-sm" style="font-size: 14px; margin-top: 10px;">
        <thead style="height: 35px;">
            <?php $contest='..\app\Http\Controllers\actionController.php';$country='..\app\Http\Controllers\livecontestController.php';
                $contest1='..\app\Http\Controllers\contestController.php';$country1='..\app\Http\Controllers\problemController.php';$contestant='..\app\Http\Controllers\contestantController.php';?>
            <tr style="background-color: #f1f4f9;">
                <th style="min-width: 20px; font-size: 17px; width: 5%; text-align: center;" scope="col">#</th>
                <th class="pr-5" style="width: 5%; text-align: left;" scope="col">Flag</th>
                <th class="pr-5" style="width: 70%; max-width: fit-content; text-align: left;" scope="col">Country</th>
                <th class="pr-5" style="width: 5%; max-width: fit-content;" scope="col">Organizations</th>
                @auth
        ...
        <tbody>
          ...
          <tr>
            ...
            <td style="text-decoration: none;"><img src="../image/country/{{$country->flag}}" width="35" height="25" class="" style="margin-right: 4px;"></td>
            <td>{{ $country->country }}</td>
            <td style="text-align: center;">{{ app\Http\Controllers\countryController::organizations($country->country) }}</td>
            <td style="text-align: center;">
            @auth
                @if (Auth::user()->role == 'superadmin')
                    <a href="#" data-bs-toggle="modal" data-bs-target="#popup{{$country->id}}" title="Edit Problem"
                    ...
                    <a href="cy/delete/{{$country->id}}" title="Delete Country"
            ...
            @endforeach
            @if ($i==1)
                <tr style="text-align: center;"><td class="not-found" colspan="7"><h6>No Country Found</h6></td></tr>
            @endif
          <tfoot>
              <tr>
...
<div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" style="min-width: 55%;">
    <div class="modal-content" style="overflow: auto;">
        <div class="modal-header" style="height: 40px;">
            <h6 class="modal-title page_title" id="staticBackdropLabel">Add New Country </h6>
            <button type="button" class="btn-close btn-sm" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <form action=""></form>
        <form onsubmit="return validate();" action="/addCountry" id="g" name="g">
                ...
                <tr class="d-flex justify-content-between p-2" style="margin-right: 35">
                    <tr>
                        <div>
                            ...
                            <td class="p-2">
                                <input type="file" name ="country_flag" id ="country_flag">
                            </td>
                    ...
                    <tr>
                        ...
                        <td style="padding-left: 8px;">
                            <div id="flag_photo" style="width: 70px; height: 60px;" class='rounded-circle'>
                                <img src="../image/country/default_flag.jpg" alt="" style="background-color: #555; width: 70%; height: 60%;" class='rounded-circle'>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        <td><label> Country</label></td>
                        <td><input class="form-control" type="text" name="country"></td>
                    </tr>
                    ...
                    <script>
                        ...
                        $(document).ready(function () {
                          $("#country_flag").on("change", handleFileSelect);
                          selDiv = $("#flag_photo");
                        });
...
@foreach ($countries as $country)
<div style="height: 100%; width: 100%; margin: auto; display: none;"
class="modal fade" id="popup{{$country->id}}" data-bs-backdrop="static" data-bs-keyboard="false"
tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
<div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" style="min-width: 55%;">
    <div class="modal-content" style="overflow: auto;">
        <div class="modal-header" style="height: 40px;">
            <h6 class="modal-title page_title" id="staticBackdropLabel">Edit Country </h6>
            <button type="button" class="btn-close btn-sm" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <form action=""></form>
        <form onsubmit="return validate();" action="/editCountry{{$country->id}}" id="{{$country->id}}" name="{{$country->id}}">
        <div class="modal-body" style=" width: 100%; margin: auto; background-color: #f6f6f6;  overflow: auto; max-height: 500px; ">
            <table style="width: 75%; margin: auto;" class="p-3">
                <tr class="d-flex justify-content-between p-2" style="margin-right: 35">
                    <tr>
                        <div>
                            ...
                            <td class="p-2">
                                <input type="file" name ="country_flag{{$country->id}}" id ="country_flag{{$country->id}}">
                            </td>
                    ...
                    <tr style="display: none;">
                        <div>
                            ...
                            <td class="p-2">
                                <input type="text" name ="pi{{$country->id}}" id ="pi{{$country->id}}" value="">
                            </td>
                    ...
                    <tr>
                        <td></td>
                        <td style="padding-left: 8px;">
                            <div id="flag_photo{{$country->id}}" style="width: 70px; height: 60px;" class='rounded-circle'>
                                <img src="../image/country/{{$country->flag}}" alt="" style="width: 70%; height: 60%;" class='rounded-circle'>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        <td><label> Country</label></td>
                        <td><input class="form-control" type="text" name="country" value="{{$country->country}}"></td>
                    </tr>

                    <script>
                        integrity="sha256-/xUj+3OJU5yExlq6GSYGSHk7tPXikynS7ogEvDej/m4="
                        crossorigin="anonymous"
                        var selDiv{{$country->id}} = "";
                        var storedFiles{{$country->id}} = [];
                        $(document).ready(function () {
                          $("#country_flag{{$country->id}}").on("change", handleFileSelect{{$country->id}});
                          selDiv{{$country->id}} = $("#flag_photo{{$country->id}}");
                        });

                        function handleFileSelect{{$country->id}}(e{{$country->id}}) {
                          var files{{$country->id}} = e{{$country->id}}.target.files;
                          var filesArr{{$country->id}} = Array.prototype.slice.call(files{{$country->id}});
                          filesArr{{$country->id}}.forEach(function (f{{$country->id}}) {
                            if (!f{{$country->id}}.type.match("image.*")) {
                              return;
                            }
                            storedFiles{{$country->id}}.push(f{{$country->id}});

                            var reader{{$country->id}} = new FileReader();
                            reader{{$country->id}}.onload = function (e) {
                                document.getElementById("pi{{$country->id}}").value = f{{$country->id}}.name;
                              var html{{$country->id}} =
                                '<input type="image" id="image{{$country->id}}" src="' +
                                e.target.result +
                                "\" data-file='" +
                                f{{$country->id}}.name +
                                "alt='Category Image' height='100%' width='100%' class='rounded-circle'>";
                              selDiv{{$country->id}}.html(html{{$country->id}});
                            };
                            reader{{$country->id}}.readAsDataURL(f{{$country->id}});
                          });
                        }
                      </script>
                </tr>
