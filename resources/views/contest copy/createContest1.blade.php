...
@section('title') Contest-Detail @endsection
...
<?php $type_radio = 'not-selected'; ?>
    <form action="/c/contestDetail/{{$contestt}}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="container p-1"  style="width: 80%; margin: auto; background-color: #fff; padding-right: 14px; border-radius: 5px;">
            @foreach ($contests as $contest)

            <div class="title justify-content-between d-flex" style="align-self: center; width: 80%; margin: auto; margin-top: 20px;">
                <h3 style="padding-right: 50px;"  class=" page_title fade-in-left">Create Contest </h3>
                <div class=" d-flex"><h6 class="pt-2 pl-2" style ="color: #494949"><strong>Detail </strong> </h6>
            ...
            <div style="border-radius: 10px; width: 100%;">
                <div class="justify-content-between p-3" style=" width: 85%; margin: auto; background-color: #fff">
                    ...
                    <table>
                        <tr>
                            ...
                            <td class="p-2" >
                                <input class="form-control"  style="width: 500px;" type="text" name='name' id="name" value="{{$contest->name}}">
                            </td>
                        </tr>
                        <tr>
                            <td class="p-2">
                            ...
                            <td class="p-2" >
                                {{-- <div>
                                        ...
                                        function readURL(input){
                                            if (input.files && input.files[0]) {
                                                ...
                                                reader.onreadystatechange = function(e){
                                                    $('#logo')
                                                    .attr('src', '../../image/contest/'+e.target.result)
                                                    .width(200)
                                                    .height(190);
                                                };
                                    ...
                                    <button id="files" onclick="document.getElementById('file').click(); return false;"
                                            class="p-2"
                                            style="border: 1px solid #ccc;
                                                background-color: #eee;
                                                border-radius: 25px;
                                                ">Update Logo</button>
                                    <input type="file" id="file" accept="image/*" onchange="readURL(this);" style="visibility: hidden; color: transparent;">
                                </div> --}}
                                <div class="container">
                                    <div class="d-flex justify-content-around" style="width: 100%;">
                                        <div id="selectedBanner">
                                            @if ($contest->logo != "")
                                                <img style="margin: 20px;" src="../../image/contest/{{$contest->logo}}" width="280" height="180" name="existing_logo">
                                            @endif
                                        </div>
                                    </div>
                        ...
                        <tr>
                            ...
                            <div class="container">
                                ...
                                <div id="existing_logoimage" style="max-width: 250px; max-width: 250px; width: fit-content; height: fit-content;">
                                    <input style="float: right; color: rgb(255, 255, 255); border: none; cursor: none;" value= "{{$contest->logo}}" name="logo_name" id="logo_name">
                                </div>
                            </td>
                        </tr>
                              ...
                              filesArr.forEach(function (f) {
                                ...
                                reader.onload = function (e) {
                                  var html =
                                    ...
                                    "\" data-file='" +
                                    f.name +
                                    "alt='Category Image' height='200px' width='300px'>";
                                  selDiv.html(html);
                                //   document.getElementById('existing_logo').style.visibility = "hidden";
                                //   document.getElementById('existing_logoimage').style.visibility = "hidden";
                        ...
                        <tr>
                            ...
                            <td class="p-2 " colspan="2" style="align-self: right;">
                                <input  type="radio" name='type_radio' id="individual" value="Individual"
                                    @if ($contest->type == "Individual")
                                        checked = "true"
                                    @endif  onclick="return selectType()"> Individual</input><br>

                                <input type="radio" name='type_radio' id="team" value="Team"
                                    @if ($contest->type == "Team")
                                        checked = "true"
                                    @endif  onclick="selectType()"> Team</input>

                                <input type="text" style="margin-left: 50px; color: white; border: none; cursor: none;" id="radio" name="radio" value="{{$contest->type}}">
                            </td>
                        </tr>
                        <tr>
                            <div>
                            ...
                            <td class="p-2 " colspan="2" style="align-self: right;">
                                <input class="form-control"   type="text" name='place' id="place" value="{{$contest->place}}">
                            </td>
                        </tr>
                    </table>
                </div>
                ...
                <div class="justify-content-between p-3" style=" width: 85%; margin: auto; background-color: #fff">
                    ...
                    <table>
                        <tr>
                            ...
                            <td class="p-2">
                                <input class="form-control"  style="width: 500px;" type="text" name='owner' id="owner" value="{{$contest->owner}}">
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td class="p-2" >
                                <input class="form-control"  style="width: 500px;" type="text" name='creator' id="creator" value="{{$contest->creator}}" disabled="true">
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td class="p-2" >
                                <input class="form-control"  style="width: 500px;" type="text" name='contestants' id="contestants" value="{{$contest->officials}}">
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td class="p-2" >
                                <input class="form-control"  type="text" style="width: 500px;" name='sponsers' id="sponsers" placeholder="separate sponsers with comma(,)" value="{{$contest->sponsers}}">
                            </td>
                        </tr>
                            ...
                            <td class="p-2" >
                                <div class="container">
                                    <div class="d-flex justify-content-around" style="width: 20%;">
                                        <div id="selectedBanner1"  class="d-flex" style="margin-left: 200px;">
                                            @if ($contest->logo != "")
                                                @foreach ($sponsers as $sponser)
                                                <img style="margin: 20px; width: 200px; height:150px;"
                                                    src="../../image/sponser/{{$sponser->sponser_logo}}" name="existing_logo{{$sponser->sponser_logo}}" id="{{$sponser->sponser_logo}}">
                                                @endforeach
                                            @endif
                                        </div>
                                    </div>
                              ...
                              filesArr.forEach(function (f) {
                                ...
                                reader.onload = function (e) {
                                  var html{{$ii}} =
                                    ...
                                    "\" data-file='" +
                                    f.name +
                                    "alt='Category Image' height='50px' width='90px'>";
                        ...
                        <tr>
                            <td></td>
                            <td>
                                <div id="pre_sponsers_logoimage" style="max-width: 250px; max-width: 150px; width: fit-content; height: fit-content;">
                                    {{-- <input  name='Esponserslogo' id="Esponserslogo" multiple="true" type="image" src="../../image/{{$contest->sponserslogo}}" alt="" width="250" height="200"> --}}
                                </div>
            ...
            <div style="border-radius: 5px; width: 100%;">
                <div class="justify-content-between p-3" style=" width: 85%; margin: auto; background-color: #fff">
                    ...
                    <table style="width: 100%;">
                        <tr>
                            <td class="p-3">
                                <textarea style="border: 1px solid #ccc; width: 97%; margin-left: 10px; "
                                            type="textarea" rows="12"
                                            name='description'
                                            placeholder=" ... say something about the contest..."
                                            id="description" >{{$contest->description}}</textarea>
                            </td>
                        </tr>
                    </table>
                </div>
            ...
            <div ></div>
            <div class="d-flex">
                <button href="/c/toSchedule/{{$contestt}}" class="anchor p-2" style="margin-right: 20px; width: 85px;">Next</button>
...
{{-- ************************************************************************************************************--}}
    ...
    <div class="container p-2"  style="width: 700px; margin: auto;">
        ...
        <div style="border-radius: 5px; width: 700px;">
            <div class="justify-content-between p-3" style=" width: 85%; margin: auto; background-color: #fff">
                ...
                <table>
                    <tr>
                        ...
                        <td class="p-2" >
                            <input style="width: 500px;" type="text" name='name' id="name" >
                        </td>
                    </tr>
                    <tr>
                        <td class="p-2">
                    ...
                    <tr>
                        ...
                        <td class="d-flex">
                            <div id="logoimage" style="max-width: 250px; max-width: 250px; width: fit-content; height: fit-content;">
                                {{-- <input name='Elogo' id="Elogo" type="image" src="../..image/contest/{{$contest->logo}}" alt="" width="250" height="250"> --}}
                                <input style="float: right; color: white; border: none; cursor: none;" name="logo_name" id="logo_name">
                                {{-- <input style="text-align: left; border: none;" disabled="true" type="text" name ="logo_name"
                                        id ="logo_name" value="{{$contest->logo}}"> --}}
                            </div>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="p-2 " colspan="2" style="align-self: right;">
                            <input  type="radio" name='type_radio' id="individual" value="Individual" checked = "true"
                                    onclick="return selectType()"> Individual</input><br>

                            <input type="radio" name='type_radio' id="team" value="Team"
                                    onclick="selectType()"> Team</input>

                            <input type="text" style="margin-left: 50px; color: white; border: none; cursor: none;" id="radio" name="radio" >
                        </td>
                    </tr>
                    <tr>
                        <div>
            ...
            <div class="justify-content-between p-3" style=" width: 85%; margin: auto; background-color: #fff">
                ...
                <table>
                    <tr>
                        ...
                        <td class="p-2">
                            <input style="width: 500px;" type="text" name='owner' id="owner">
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="p-2" >
                            <input style="width: 500px;" type="text" name='contestants' id="contestants" >
                        </td>
                    </tr>
                        ...
                        <td class="p-2" >
                            <div class="container">
                                <div class="d-flex justify-content-around" style="width: 50%;">
                                    <div id="selectedBanner3">
                                        @if ($contest->logo != "")
                                            @foreach ($sponsers as $sponser)
                                            <img style="margin: 20px;" src="../../image/sponser/{{$sponser->sponser_logo}}" style="width: 100px; height:60px;" name="existing_logo" id="{{$sponser->sponser_logo}}">
                                            @endforeach
                                        @endif
                                    </div>
                                </div>
                    ...
                    <script>
                        ...
                        function handleFileSelect(e) {
                          var files = e.target.files;
                          var filesArr = Array.prototype.slice.call(files);@php $ii=0; @endphp
                          filesArr.forEach(function (f) {
                            if (!f.type.match("image.*")) {
                              return;
                            }
                            ...
                            reader.readAsDataURL(f);alert('123');
                          });
                        }
                      </script>
                    <tr>
                        <td></td>
                        <td>
                            <div id="sponsers_logoimage" style="max-width: 250px; max-width: 250px; width: fit-content; height: fit-content;">
                                <input  name='Esponserslogo' id="Esponserslogo" multiple="true" type="image" src="" alt="" width="250" height="200">
                            </div>
        ...
        <div style="border-radius: 5px; width: 700px;">
            <div class="justify-content-between p-3" style=" width: 85%; margin: auto; background-color: #fff">
                ...
                <table style="width: 100%;">
                    <tr>
                        <td class="p-3">
                            <textarea style="border: none; width: 97%; margin-left: 10px; " type="textarea" rows="12" name='description' id="description" >{{$contest->description}}</textarea>
                        </td>
                    </tr>
                </table>
            </div>
        ...
        <div class="save p-5 justify-content-between d-flex " style="width: 700px;">
            ...
            <div class="d-flex">
                <button href="/c/toSchedule/{{$contestt}}" class="anchor p-2" style="margin-right: 20px; width: 85px;">Next</button>
                <input class="anchor p-2" type="submit" value="Save2" >
            </div>
        </div>
        @endforeach
    </div>
...
<script type="text/javascript">
    function selectType(){
        var rd1 = document.getElementById("individual");
        var rd2 = document.getElementById("team");

        if (rd1.checked == true) {
            document.getElementById('radio').value = 'Individual';
        }
        else if (rd2.checked == true) {
            document.getElementById('radio').value = 'Team';
        }
